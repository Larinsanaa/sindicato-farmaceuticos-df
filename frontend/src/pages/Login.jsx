...
export default function Login() {
    ...
    async function entrar(evento) {
        ...
        try {
            ...
            const tipoUsuarioNormalizado = usuario.tipo === 'presidente' ? 'administrador' : usuario.tipo;
            const tipoSelecionadoNormalizado = tipoLogin === 'presidente' ? 'administrador' : tipoLogin;

            if (tipoUsuarioNormalizado !== tipoSelecionadoNormalizado) {
                throw new Error(`Este acesso é de ${tipoUsuarioNormalizado}. Selecione o perfil correto.`);
            }
                        ...
                        {tela === 'cadastro' ? (
                            ...
                            <form className="space-y-5" onSubmit={entrar}>
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                                    <button className="font-semibold text-slate-600 underline" type="button" onClick={() => navigate('/redefinir-senha')}>Esqueceu sua senha?</button>
